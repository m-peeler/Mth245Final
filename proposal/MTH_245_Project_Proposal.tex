...
%%%%%%%%%% PART (c) %%%%%%%%%%		
	...
	\begin{itemize}
		\vspace{.2cm}
		\item \textbf{Predictor Variable 1: Female Labor Force Participation Rate 2015. Continuous quantitative.}
		\vspace{.2cm}
		\item \textbf{Predictor Variable 2: Country Name. Catagorical.}
		\vspace{.2cm}
		\item \textbf{Predictor Variable 3: Nominal Variable for Developing Index. Catagorical.}
		\vspace{.2cm}
		\item \textbf{Predictor Variable 4: Entrepreneurship Index 2015. Continuous quantitative.}
		\vspace{.2cm}
		\item \textbf{Predictor Variable 5: Inflation Rate 2015. Continuous quantitative.}
		\vspace{.2cm}
...
There are 60 observations in the dataset.
